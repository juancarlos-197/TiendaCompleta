...
<?php if ( is_single() ) : ?>
	...
	<?php the_content(); ?>
			...
			<?php
			wp_link_pages( array(
				'before' => '<div class="page-links">' . __( 'Pages:', 'corpobox-lite' ),
				'after'  => '</div>',
			) );
			?>
	</div><!-- .entry-content -->
	...
	<footer class="entry-meta">
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'corpobox-lite' ), __( '1 Comment', 'corpobox-lite' ), __( 'Comments: %', 'corpobox-lite' ) ); ?></span>
		<?php endif; ?>

		<?php edit_post_link( __( 'Edit', 'corpobox-lite' ), '<span class="edit-link">', '</span>' ); ?>
	</footer><!-- .entry-meta -->
