...
<nav id="site-navigation" class="main-navigation" role="navigation">
	<h1 class="menu-toggle"><?php _e( 'Menu', 'corpobox-lite' ); ?></h1>
<?php 
...
<?php
	if ( !is_front_page() && false === get_theme_mod( 'corpobox_head_pages', false ) ) {
		get_template_part( 'template-parts/header' );
	}
	if ( is_front_page() && is_home() || is_page_template( 'template-home-main.php' ) ) {
