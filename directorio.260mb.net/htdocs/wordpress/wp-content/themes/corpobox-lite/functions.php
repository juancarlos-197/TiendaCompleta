...
function corpobox_setup() {
	 ...
	 */
	load_theme_textdomain( 'corpobox-lite', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'top' => __( 'Top Menu', 'corpobox-lite' ),
		'primary' => __( 'Primary Menu', 'corpobox-lite' ),
		'social' => __( 'Social Menu', 'corpobox-lite' ),
	) );
...
function corpobox_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar Posts', 'corpobox-lite' ),
		'id'            => 'sidebar-1',
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Pages', 'corpobox-lite' ),
		'id'            => 'sidebar-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
       ...
       register_sidebar(array(
            'name' => __('Home Page Section', 'corpobox-lite'),
            'description' => __('The widget area with 2, 3, 4-column Home Main page template.', 'corpobox-lite'),
       ...
       register_sidebar(array(
            'name' => __('Footer1', 'corpobox-lite'),
            'description' => __('Located in the footer left.', 'corpobox-lite'),
            'id' => 'footer1',
            'before_title' => '<h5>',
            'after_title' => '</h5>',
       ...
       register_sidebar(array(
            'name' => __('Footer2', 'corpobox-lite'),
            'description' => __('Located in the footer center.', 'corpobox-lite'),
            'id' => 'footer2',
            'before_title' => '<h5>',
            'after_title' => '</h5>',
            'before_widget' => '<div class="widget">',
       ...
       register_sidebar(array(
            'name' => __('Footer3', 'corpobox-lite'),
            'description' => __('Located in the footer right.', 'corpobox-lite'),
            'id' => 'footer3',
            'before_title' => '<h5>',
            'after_title' => '</h5>',
            'before_widget' => '<div class="widget">',
...
function corpobox_fonts_url() {
    ...
    $open_sans = _x( 'on', 'Open Sans font: on or off', 'corpobox-lite' );
...
add_action( 'wp_enqueue_scripts', 'corpobox_woocommerce_css' );
	...
	function corpobox_woocommerce_widgets_init() {
		register_sidebar(array(
		'name' => __('Store Sidebar', 'corpobox-lite'),
		'description' => __('Located in the sidebar woocommerce page.', 'corpobox-lite'),
		'id' => 'store',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
...
function corpobox_projects_fields( $fields ) {
	$fields['date'] = array(
	    'name' 			=> __( 'Date', 'corpobox-lite' ),
	    'description' 	=> __( 'Enter a date for this project. (Optional)', 'corpobox-lite' ),
	    'type' 			=> 'text',
	    'default' 		=> '',
	    'section' 		=> 'info'
	);
...
function corpobox_wooproject_sidebar() {
	register_sidebar(array(
	'name' => __('Project', 'corpobox-lite' ),
	'description' => __('Located into Project sidebar', 'corpobox-lite' ),
	'id' => 'project',
