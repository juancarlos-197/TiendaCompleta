        		...
        		public function render_content() {
            			$dropdown = wp_dropdown_categories(
                				array(
                    					...
                    					'echo'              => 0,
                    					'show_option_none'  => __( '&mdash; Select &mdash;', 'corpobox-lite' ),
                    					'option_none_value' => '0',
                    					'selected'          => $this->value(),
                				)
            			);
 ...
 //CONTROL
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'headerbg_color',
            array(
                'label'      => __( 'Header BG Color', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 10,
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'link_color',
            array(
                'label'      => __( 'Link Color', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 11,
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'hover_color',
            array(
                'label'      => __( 'Hover Color', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 20,
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'menu_color',
            array(
                'label'      => __( 'Menu Background', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 30,
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'menu_current',
            array(
                'label'      => __( 'Menu Current BG', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 40,
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'main_color',
            array(
                'label'      => __( 'Main text Color', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 45,
                'settings'   => 'corpobox_main_color'
            )
        )
    );
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'acent_color',
            array(
                'label'      => __( 'Accent Color', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 48,
                'settings'   => 'corpobox_acent_color'
            )
        )
    );
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'footer_color',
            array(
                'label'      => __( 'Footer TXT Color', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 200,
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'footerbg_color',
            array(
                'label'      => __( 'Footer BG Color', 'corpobox-lite' ),
                'section'    => 'colors',
	'priority'  => 201,
	...
	$wp_customize->add_section(
		...
		array(
			'title'     => __( 'Logo Options', 'corpobox-lite' ),
			'priority'  => 20
		)
	);
	$wp_customize->add_setting( 
	...
	$wp_customize->add_control(
		...
		array(
			...
			'label'     => __( 'No Frame logo', 'corpobox-lite' ),
			'type'      => 'checkbox'
		)
	);
	/* Logo Image Upload */
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'logo_upload', array(
		'label' => __( 'Logo Image', 'corpobox-lite' ),
		'section' =>  'corpobox_logo_options',
	...
	$wp_customize->add_section(
		...
		array(
			'title'     => __( 'Home Tagline', 'corpobox-lite' ),
			'priority'  => 70
		)
	);
	$wp_customize->add_setting(
	...
	$wp_customize->add_control( new corpobox_Textarea_Control( $wp_customize, 'home_tagline', array(
			'label' => __( 'Tagline Text', 'corpobox-lite' ),
    	...
    	$wp_customize->add_control(
        		new WP_Customize_Color_Control(
            			...
            			'home_tagline_bgcolor',
            				array(
                				'label'      => __( 'Background Color', 'corpobox-lite' ),
                				'section'    => 'corpobox_home_tagline',
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'home_tagline_bgimg', array(
		'label' => __( 'Background Image', 'corpobox-lite' ),
		'section' =>  'corpobox_home_tagline',
	...
	$wp_customize->add_section(
		'corpobox_home_page',
		array(
			'title'     => __( 'Homepage Options', 'corpobox-lite' ),
			'description' => __( 'This only works for a page template named Home Main.', 'corpobox-lite' ),
			'priority'  => 75
		)
	);
	$wp_customize->add_setting( 
	...
	$wp_customize->add_control(
		...
		array(
			...
			'label'     => __( 'Hide Page Title', 'corpobox-lite' ),
			'type'      => 'checkbox'
		)
	);
	/* Category */
	...
	$wp_customize->add_control(
    		new Corpobox_Category_Control(
       				 ...
       				 array(
					'label'    => __( 'Recent Posts Category', 'corpobox-lite' ),
	...
	$wp_customize->add_setting(
		...
		array(
			'default'            => __( 'Recent Posts', 'corpobox-lite' ),
	...
	$wp_customize->add_control(
		...
		array(
			'section'  => 'corpobox_home_page',
			'label'    => __( 'Recent Posts Title', 'corpobox-lite' ),
			'type'     => 'text'
		)
	);
	$wp_customize->add_setting(
	...
	$wp_customize->add_control(
		...
		array(
			'section'  => 'corpobox_home_page',
			'label'    => __( 'Number Posts on Home', 'corpobox-lite' ),
			'type' => 'select',
			'choices' => array(
				'3' => '3',
				'6' => '6',
	...
	$wp_customize->add_section(
		...
		array(
			'title'     => __( 'Call to Action', 'corpobox-lite' ),
			'priority'  => 400
		)
	);
	$wp_customize->add_setting(
...
//Call to Action CONTROL
	$wp_customize->add_control(
		...
		array(
			...
			'label'    => __( 'Call Action Text', 'corpobox-lite' ),
			'type'     => 'text'
		)
	);
	$wp_customize->add_control(
		...
		array(
			'section'  => 'corpobox_call_action',
			'label'    => __( 'Button Text', 'corpobox-lite' ),
			'type'     => 'text'
		)
	);
	$wp_customize->add_control(
		...
		array(
			'section'  => 'corpobox_call_action',
			'label'    => __( 'URL Button', 'corpobox-lite' ),
			'type'     => 'text'
		)
	);
	/*-----------------------------------------------------------
	...
	$wp_customize->add_section(
		...
		array(
			'title'     => __( 'Footer Copyright', 'corpobox-lite' ),
			'priority'  => 600
		)
	);
	$wp_customize->add_setting(
...
//Copyright CONTROL
	$wp_customize->add_control(
		...
		array(
			...
			'label'    => __( 'Copyright', 'corpobox-lite' ),
			'type'     => 'text'
		)
	);
	/*-----------------------------------------------------------*
	...
	$wp_customize->add_section(
		...
		array(
			'title'     => __( 'Display Options', 'corpobox-lite' ),
			'priority'  => 700
		)
	);
	$wp_customize->add_setting( 
	...
	$wp_customize->add_control(
		...
		array(
			...
			'label'     => __( 'Hide Submenu pages', 'corpobox-lite' ),
			'type'      => 'checkbox'
		)
	);
	$wp_customize->add_setting( 
	...
	$wp_customize->add_control(
		...
		array(
			'section'   => 'corpobox_display_options',
			'label'     => __( 'Hide header page', 'corpobox-lite' ),
			'type'      => 'checkbox'
		)
	);
	$wp_customize->add_setting( 
	...
	$wp_customize->add_control(
		...
		array(
			'section'   => 'corpobox_display_options',
			'label'     => __( 'Disable lightbox image', 'corpobox-lite' ),
			'type'      => 'checkbox'
		)
	);
...
h1.page-title, .call-action-txt span { color: <?php echo esc_attr( get_theme_mod( 'corpobox_acent_color', '#2c2c2c' ) ); ?>; }
.entry-content { color: <?php echo esc_attr( get_theme_mod( 'corpobox_main_color', '#2c2c2c' ) ); ?>; }
